...
public sealed class TicketFilteringAndSortingIntegrationTests
{
    ...
    public async Task Customer_should_filter_tickets_by_status()
    {
        ...
        _factory.VerifyAccount(authenticatedAgent.AccessToken);
    ...
    public async Task Requester_filter_should_not_expose_another_customers_ticket()
    {
        ...
        _factory.VerifyAccount(firstCustomer.AccessToken);
    ...
    /// </summary>
    private async Task<TicketListEnvelope> ReadListAsync(
        HttpResponseMessage response)
    {
    ...
    /// </summary>
    private async Task<TicketListEnvelope> GetListAsync(
        HttpClient client,
        string requestUri)
    {
